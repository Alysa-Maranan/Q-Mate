        ...
        <div class="chat-container">
                ...
                <div class="customer-list">
                    <div class="customer-list-header">
                        <div class="customer-list-header-top">
                            ...
                            @else
                                <span class="unread-badge" id="unreadCountBadge" style="display:none;">
                                    0 unread
                                </span>
                            @endif
                        </div>
                    ...
                    <div class="customer-items" id="customerItems">
                        @forelse($customers as $customer)
                            ...
                            @php
                                ...
                                $hasUnread =
                                    $lastChat &&
                                    $lastChat->sender === 'customer' &&
                                    $lastChat->status === 'sent';
                            @endphp

                            <div
                                class="customer-item {{ $hasUnread ? 'unread' : '' }}"
                    ...
                    >
                        ...
                        <div class="quick-replies" id="quickReplies">
                            ...
                            <button
                                ...
                                onclick="useQuickReply('Hello! How can I help you today?')"
                            >
                            ...
                            <button
                                class="quick-reply-btn"
                                onclick="useQuickReply('Your order is being processed.')"
                            >
                            ...
                            <button
                                class="quick-reply-btn"
                                onclick="useQuickReply('For concerns about your quails, please provide details.')"
                            >
                            ...
                            <button
                                class="quick-reply-btn"
                                onclick="useQuickReply('Thank you for contacting us! Have a great day!')"
                            >
                        ...
                        >
                            ...
                            >
                                ...
                                <img
                                    id="imagePreview"
                                    style="width:52px; height:52px; object-fit:cover; border-radius:10px; border:1px solid #d7ccc8;"
                                />
            ...
            >
                ...
                <div class="profile-section">
                    ...
                    <p
                        style="color: #4e342e; font-size: 0.9rem; margin: 0;"
                ...
                <div class="profile-section">
                    ...
                    >
                        ...
                        <button
                            ...
                            style="width: 100%; justify-content: center; display: flex; align-items: center; gap: 0.5rem; padding: 0.6rem;"
                            onclick="sendQuickTemplate('order_status')"
                        >
                            <i class="ph-bold ph-package"></i>
                            Send Order Status
                        </button>
                        ...
                        <button
                            class="btn btn-secondary"
                            style="width: 100%; justify-content: center; display: flex; align-items: center; gap: 0.5rem; padding: 0.6rem;"
                            onclick="sendQuickTemplate('feeding_guide')"
                        >
                            <i class="ph-bold ph-bird"></i>
                            Send Feeding Guide
                        </button>
                        ...
                        <button
                            class="btn btn-secondary"
                            style="width: 100%; justify-content: center; display: flex; align-items: center; gap: 0.5rem; padding: 0.6rem;"
                            onclick="sendQuickTemplate('contact_info')"
                        >
...
<script>
    ...
    async function selectCustomer(customerId) {
        ...
        try {
            const response = await fetch(
                `/admin/chat/customer/${customerId}`
            );
            ...
            if (data.success) {
                ...
                document.getElementById('chatHeaderEmail').textContent =
                    data.customer.email;
                ...
                updateCustomerProfile(currentCustomerId, {
                    ...
                    messageCount:
                        data.customer.messageCount ||
                        data.chats.length,
                    daysActive:
                        data.customer.daysActive ||
                        1,
                    lastActive:
                        data.chats.length > 0
                            ? formatTimeAgo(data.chats[0].created_at)
                            : 'Just now'
                });
            }
    ...
    function renderMessages(chats, customerName) {
        ...
        chats.forEach(chat => {
             ...
             * IMAGE FIX:
             *
             * Supabase images are already full HTTPS URLs.
             * Old local images may still contain a normal storage path.
             *
             * Therefore:
             * - https://... => use directly
             * - /storage/... or old path => prepend /storage/
             */

            const imageUrl = chat.image_path
                ? (
                    chat.image_path.startsWith('http://') ||
                    chat.image_path.startsWith('https://')
                        ? chat.image_path
                        : '/storage/' + chat.image_path
                )
                : '';
    ...
    function filterCustomers() {
        ...
        if (
            ...
            if (!noResultsEl) {
                ...
                msg.style.cssText =
                    'padding: 2rem; text-align: center; color: #8d6e63;';

                msg.innerHTML =
                    '<i class="ph-fill ph-magnifying-glass" style="font-size: 2rem; opacity: 0.3;"></i><p style="margin-top: 1rem;">No customers found</p>';
